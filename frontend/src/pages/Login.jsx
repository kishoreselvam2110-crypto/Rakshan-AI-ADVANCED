    ...
    if (step === 2) {
      ...
      const fillDigit = (index) => {
        ...
        if (index < 4) {
          ...
          setTimeout(() => {
            if (!mounted) return;
            toast.success("Rakshan Access Granted!");
            navigate("/home");
          }, 1500);
        }
      };
        ...
        {step === 1 ? (
          ...
          >
            ...
            <div className="flex flex-col items-center mb-8 md:mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-black tracking-tighter text-white">Rakshan <span className="text-indigo-500">AUTH</span></h2>
