        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-2">
              <span className="text-indigo-300/40 font-mono tracking-widest text-xs uppercase">Ministry of Tourism • Active Security Grid</span>
              <DataStatusBadge status="LIVE" confidence={98} source="Socket.IO & Telemetry Stream" />
            </div>
          </div>
        </div>
