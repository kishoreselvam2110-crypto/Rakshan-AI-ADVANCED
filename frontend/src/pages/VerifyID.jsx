...
// Duplicate handleVerify removed
  ...
  return (
    <div className="max-w-xl mx-auto p-6">
      ...
      <div className="space-y-6">
        {!scanResult ? (
          isScanning ? (
            <div className="relative w-full h-[300px] bg-black/30 flex items-center justify-center">
              <QrReader
              ...
              />
              <button onClick={() => setIsScanning(false)} className="absolute top-2 right-2 p-2 bg-white/10 rounded-full text-white">
                <X size={20} />
              </button>
            </div>
          ) : (
